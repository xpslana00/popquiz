...
const DATASET_VERSION = "20260712-9";
...
const CZECH_TEXT_REPLACEMENTS = [
  ...
  [/\bvecere\b/g, "večeře"],
  [/\bporad\b/g, "pořád"],
  [/\bvetsine\b/g, "většině"],
  [/\bprotivnik\b/g, "protivník"],
  [/\bprvniho\b/g, "prvního"],
  [/\bprvnim\b/g, "prvním"],
  [/\bprvnich\b/g, "prvních"],
  [/\bciste\b/g, "čistě"],
  [/\bkouzelne\b/g, "kouzelné"],
  [/\bPoterove\b/g, "Potterově"],
  [/\bsvete\b/g, "světě"],
  [/\bLondyne\b/g, "Londýně"],
  [/\bKrive\b/g, "Křivé"],
  [/\bnamesti\b/g, "náměstí"],
  [/\bJake\b/g, "Jaké"],
  [/\bcislo\b/g, "číslo"],
  [/\bDursleyovych\b/g, "Dursleyových"],
  [/\bletajicich\b/g, "létajících"],
  [/\bzlaty\b/g, "zlatý"],
  [/\bmicek\b/g, "míček"],
  [/\bdile\b/g, "díle"],
  [/\bdilu\b/g, "dílu"],
  [/\bnastupisti\b/g, "nástupišti"],
  [/\bctvrtiny\b/g, "čtvrtiny"],
  [/\bctvrt\b/g, "čtvrt"],
  [/\bochrance\b/g, "ochránce"],
  [/\bSlecna\b/g, "Slečna"],
  [/\bcasovac\b/g, "časovač"],
  [/\bpouzije\b/g, "použije"],
  [/\bvydava\b/g, "vydává"],
  [/\bCtvrtem\b/g, "Čtvrtém"],
  [/\bdruhy\b/g, "druhý"],
  [/\bsampion\b/g, "šampion"],
  [/\bSvedsky\b/g, "Švédský"],
  [/\bCinsky\b/g, "Čínský"],
  [/\buci\b/g, "učí"],
  [/\bstudentska\b/g, "studentská"],
  [/\bzalozi\b/g, "založí"],
  [/\bjehoz\b/g, "jehož"],
  [/\bucebnic\b/g, "učebnic"],
  [/\bdum\b/g, "dům"],
  [/\bzdedi\b/g, "zdědí"],
  [/\bradio\b/g, "rádio"],
  [/\bposlouchaji\b/g, "poslouchají"],
  [/\bvytahne\b/g, "vytáhne"],
  [/\bmec\b/g, "meč"],
  [/\bmudlovskych\b/g, "mudlovských"],
  [/\bstudii\b/g, "studií"],
  [/\bzabiji\b/g, "zabijí"],
  [/\bzacatku\b/g, "začátku"],
  [/\bsedmeho\b/g, "sedmého"],
  [/\bclen\b/g, "člen"],
  [/\bdoprovazi\b/g, "doprovází"],
  [/\bprofesne\b/g, "profesně"],
  [/\bprezdivku\b/g, "přezdívku"],
  [/\bnejvyssi\b/g, "nejvyšší"],
  [/\bozeni\b/g, "ožení"],
  [/\bdite\b/g, "dítě"],
  [/\bpuvodni\b/g, "původní"],
  [/\bteoreticke\b/g, "teoretické"],
  [/\bzenou\b/g, "ženou"],
  [/\bdava\b/g, "dává"],
  [/\bmisto\b/g, "místo"],
  [/\bchytace\b/g, "chytače"],
  [/\bzajima\b/g, "zajímá"],
  [/\bzpusobi\b/g, "způsobí"],
  [/\bnapeti\b/g, "napětí"],
  [/\bdetstvi\b/g, "dětství"],
  [/\brekne\b/g, "řekne"],
  [/\bnekdy\b/g, "někdy"],
  [/\bkdyz\b/g, "když"],
  [/\bspolecne\b/g, "společně"],
  [/\bposledni\b/g, "poslední"],
  [/\bscena\b/g, "scéna"],
  [/\bniz\b/g, "níž"],
  [/\bvysoka\b/g, "vysoká"],
  [/\bzrzava\b/g, "zrzavá"],
  ...
  [/\btesne\b/g, "těsně"],
  [/\bpred\b/g, "před"],
  [/\bVickrat\b/g, "Víckrát"],
  [/\bukaze\b/g, "ukáže"],
  [/\bcela\b/g, "celá"],
  [/\bklicove\b/g, "klíčově"],
  [/\bSpolecna\b/g, "Společná"],
  [/\bVecere\b/g, "Večeře"],
  [/\boficialni\b/g, "oficiální"],
  [/\bsetka\b/g, "setká"],
  [/\bjedne\b/g, "jedné"],
  [/\bzivote\b/g, "životě"],
  [/\bbyte\b/g, "bytě"],
  [/\bkorejskem\b/g, "korejském"],
  [/\blide\b/g, "lidé"],
  [/\bhraji\b/g, "hrají"],
  [/\bzivot\b/g, "život"],
  [/\bZelene\b/g, "Zelené"],
  [/\bteplaky\b/g, "tepláky"],
  [/\bDetske\b/g, "Dětské"],
  [/\bjake\b/g, "jaké"],
  [/\bJake\b/g, "Jaké"],
  [/\bodehrava\b/g, "odehrává"],
  [/\bItalie\b/g, "Itálie"],
  [/\bSpanelsko\b/g, "Španělsko"],
  [/\bmesta\b/g, "města"],
  [/\bKralovska\b/g, "Královská"],
  [/\btvurce\b/g, "tvůrce"],
  [/\bSezona\b/g, "Sezóna"],
  [/\batmosferou\b/g, "atmosférou"],
  [/\bvesmiru\b/g, "vesmíru"],
  [/\bziskala\b/g, "získala"],
  [/\botevreny\b/g, "otevřený"],
  [/\bPolske\b/g, "Polské"],
  [/\bhleda\b/g, "hledá"],
  [/\bEstonsky\b/g, "Estonský"],
  [/\bvyvojar\b/g, "vývojář"],
  [/\bAmnezicky\b/g, "Amnézický"],
  [/\bpostapokalypticka\b/g, "postapokalyptická"],
  [/\bProceduralne\b/g, "Procedurálně"],
  [/\bVelky\b/g, "Velký"],
  [/\bcizopasniku\b/g, "cizopasníků"],
  [/\bseverni\b/g, "severní"],
  [/\bSpanelska\b/g, "Španělská"],
  [/\bchripka\b/g, "chřipka"],
  [/\bvydani\b/g, "vydání"],
  [/\bma\b/g, "má"],
  [/\bnejprodavanejsi\b/g, "nejprodávanější"],
  [/\bportu\b/g, "portů"],
  [/\bfrazi\b/g, "frázi"],
  [/\bPres\b/g, "Přes"],
  [/\bzanru\b/g, "žánru"],
  [/\bpuvodni\b/g, "původní"],
  [/\bgenru\b/g, "žánru"],
  [/\bnejvyssiho\b/g, "nejvyššího"],
  [/\bVysoka\b/g, "Vysoká"],
  [/\bhrdinska\b/g, "hrdinská"],
  [/\banimovany\b/g, "animovaný"],
  [/\bodehrava\b/g, "odehrává"],
  [/\bmagicka\b/g, "magická"],
  [/\bTrida\b/g, "Třída"],
  [/\bTridni\b/g, "Třídní"],
  [/\bsvet\b/g, "svět"],
  [/\bDivadelni\b/g, "Divadelní"],
  [/\bzver\b/g, "zvěř"],
  [/\bTri\b/g, "Tři"],
  [/\btri\b/g, "tři"],
  [/\bZiletky\b/g, "Žiletky"],
  [/\bcepicich\b/g, "čepicích"],
  [/\bcasove\b/g, "časové"],
  [/\bCasova\b/g, "Časová"],
  [/\bsmycce\b/g, "smyčce"],
  [/\bsmycka\b/g, "smyčka"],
  [/\bKava\b/g, "Káva"],
  [/\bkolac\b/g, "koláč"],
  [/\bskutecnosti\b/g, "skutečnosti"],
  [/\bPravnik\b/g, "Právník"],
  [/\bLekar\b/g, "Lékař"],
  [/\bpodvodny\b/g, "podvodný"],
  [/\bdenni\b/g, "denní"],
  [/\bbezi\b/g, "běží"],
  [/\bStribrne\b/g, "Stříbrné"],
  [/\bzahadne\b/g, "záhadné"],
  [/\bpostupne\b/g, "postupně"],
  [/\bruzni\b/g, "různí"],
  [/\bMagicky\b/g, "Magický"],
  [/\bdenik\b/g, "deník"],
  [/\boddeleni\b/g, "oddělení"],
  [/\bOddeleni\b/g, "Oddělení"],
  [/\bpameti\b/g, "paměti"],
  [/\bBuh\b/g, "Bůh"],
  [/\bBritska\b/g, "Britská"],
  [/\bKralovna\b/g, "Královna"],
  [/\bAlzbeta\b/g, "Alžběta"],
  [/\bherecek\b/g, "hereček"],
  [/\bvytvorila\b/g, "vytvořila"],
  [/\bvytvoril\b/g, "vytvořil"],
  [/\bstrilecka\b/g, "střílečka"],
  [/\bSidlo\b/g, "Sídlo"],
  [/\bVysokeho\b/g, "Vysokého"],
  [/\bkrale\b/g, "krále"],
  [/\bSeverozapadne\b/g, "Severozápadně"],
  [/\bjmenuji\b/g, "jmenují"],
  [/\bhratelne\b/g, "hratelné"],
  [/\bPrepinani\b/g, "Přepínání"],
  [/\bjaponska\b/g, "japonská"],
  [/\bFuze\b/g, "Fúze"],
  [/\bTake\b/g, "Také"],
  [/\bSeverska\b/g, "Severská"],
  [/\bpoprve\b/g, "poprvé"],
  [/\bOriginalni\b/g, "Originální"],
  [/\bPolygonalni\b/g, "Polygonální"],
  [/\bBrillant\b/g, "Brilantní"],
  [/\bvedec\b/g, "vědec"],
  [/\bNemluvi\b/g, "Nemluví"],
  [/\bpacidlo\b/g, "páčidlo"],
  [/\bPacidlo\b/g, "Páčidlo"],
  [/\breziruje\b/g, "režíroval"],
  [/\bBezejmenny\b/g, "Bezejmenný"],
  [/\bmorem\b/g, "mořem"],
  [/\bBile\b/g, "Bílé"],
  [/\bzbran\b/g, "zbraň"],
  [/\bCervena\b/g, "Červená"],
  [/\btym\b/g, "tým"],
  [/\bAustralane\b/g, "Australané"],
  [/\bCervene\b/g, "Červené"],
  [/\bTuberkuloza\b/g, "Tuberkulóza"],
  [/\bSved\b/g, "Švéd"],
  [/\bpuvodnim\b/g, "původním"],
  [/\bpetem\b/g, "pátém"],
  [/\bpomoci\b/g, "pomocí"],
  [/\bskritek\b/g, "skřítek"],
  [/\bobvineny\b/g, "obviněný"],
  [/\bvrazdy\b/g, "vraždy"],
  [/\bSmithove\b/g, "Smithové"],
  [/\bpoznamkami\b/g, "poznámkami"],
  [/\bdvojite\b/g, "dvojité"],
  [/\bSedyback\b/g, "Šedýback"],
  [/\bpotkava\b/g, "potkává"],
  [/\bslysenich\b/g, "slyšeních"],
  [/\bzije\b/g, "žije"],
  [/\bradi\b/g, "radí"],
  [/\bohledne\b/g, "ohledně"],
  [/\bmece\b/g, "meče"],
  [/\bukryva\b/g, "ukrývá"],
  [/\bskutecny\b/g, "skutečný"]
];
